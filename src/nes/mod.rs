...
impl Nes {
    ...
    pub fn run_snake(&mut self){
        self.reset_state();
        self.cpu.pc = 0x0600;
        self.cpu.bus.rom.load_hex_dump( "0600: 20 06 06 20 38 06 20 0d 06 20 2a 06 60 a9 02 85
...
0730: ea ca d0 fb 60 " );
    ...
    pub fn test_stack(& mut self){
        self.reset_state();
        self.cpu.pc = 0x0600;
        self.cpu.bus.rom.load_hex_dump("0600: a2 00 a0 00 8a 99 00 02 48 e8 c8 c0 10 d0 f5 68 99 00 02 c8 c0 20 d0 f7" );
    ...
    pub fn test_loop_performance(& mut self, loop_count : u32){
        self.reset_state();
        self.cpu.pc = 0x0600;
        self.cpu.bus.rom.load_hex_dump( "0600: a2 00 a0 00 a9 00 e8 c8 69 01 18 90 f9" );
    ...
    pub fn test_cycle_cost_with_page_jump(& mut self){
        ...
        */
        self.reset_state();
        self.cpu.pc = 0x0600;
        self.cpu.bus.rom.load_hex_dump( "0600: a9 02 8d 01 02 aa 7d ff 01 aa 7d ff 01 a9 00 " );
