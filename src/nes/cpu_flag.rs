...
impl Flag {
    ...
    pub fn set_flag_n(&mut self, set: bool) {
        self.flag_n = self.bool_to_u8(set);
    }
    pub fn set_flag_v(&mut self, set: bool) {
        self.flag_v = self.bool_to_u8(set);
    }
    pub fn set_flag_b(&mut self, set: bool) {
        self.flag_b = self.bool_to_u8(set);
    }
    pub fn set_flag_d(&mut self, set: bool) {
        self.flag_d = self.bool_to_u8(set);
    }
    pub fn set_flag_i(&mut self, set: bool) {
        self.flag_i = self.bool_to_u8(set);
    }
    pub fn set_flag_z(&mut self, set: bool) {
        self.flag_z = self.bool_to_u8(set);
    }
    pub fn set_flag_c(&mut self, set: bool) {
        self.flag_c = self.bool_to_u8(set);
    }

    pub fn get_flag_n(&self) -> bool {
        assert!(self.flag_n <= 1);
        return self.flag_n == 1;
    }
    pub fn get_flag_v(&self) -> bool {
        assert!(self.flag_v <= 1);
        return self.flag_v == 1;
    }
    pub fn get_flag_b(&self) -> bool {
        assert!(self.flag_b <= 1);
        return self.flag_b == 1;
    }
    pub fn get_flag_d(&self) -> bool {
        assert!(self.flag_d <= 1);
        return self.flag_d == 1;
    }
    pub fn get_flag_i(&self) -> bool {
        assert!(self.flag_i <= 1);
        return self.flag_i == 1;
    }
    pub fn get_flag_z(&self) -> bool {
        assert!(self.flag_z <= 1);
